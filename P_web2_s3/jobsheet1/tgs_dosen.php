...
// Metode atau Function tampilkan data dosen
    ...
    return "Nama Dosen ini adalah $this->nama dengan NIP $this->nip yang mengampu mata kuliah  $this->mataKuliah.<br>";
}
}
...
$dosen2 = new Dosen("Noa","9876","Web Development");
echo $dosen2->tampilkanDosen();